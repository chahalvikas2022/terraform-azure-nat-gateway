...
module "nat_gateway" {
  ...
  source              = "git::https://github.com/chahalvikas2022/terraform-azure-nat-gateway.git"
  name                = "app"
  environment         = "test"
...
# Examples
For detailed examples on how to use this module, please refer to the [example](https://github.com/chahalvikas2022/terraform-azure-nat-gateway/blob/master/_example) directory within this repository.

# License
This Terraform module is provided under the **MIT** License. Please see the [LICENSE](https://github.com/chahalvikas2022/terraform-azure-nat-gateway/blob/master/LICENSE) file for more details.
...
| Name | Source                                                             | Version |
|------|--------------------------------------------------------------------|---------|
| <a name="module_labels"></a> [labels](#module\_labels) | git::https://github.com/chahalvikas2022/terraform-azure-labels.git | v1.0.0 |
...
| <a name="input_managedby"></a> [managedby](#input\_managedby) | ManagedBy, eg 'vikas'.                                                                                                                  | `string` | `""`                                              | no |
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo                                                                                                           | `string` | `"vikas"`                                         | no |
